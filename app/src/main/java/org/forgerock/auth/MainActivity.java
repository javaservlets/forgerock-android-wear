...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (extras != null) {
                wear_msg = extras.getString("wear_command"); // which msg was sent from wear///mainactivity
                Log.v(TAG, "wear passed msg: " + wear_msg);
                if (wear_msg.contains("auth")) {
                    Intent loginIntent = new Intent(this, SimpleLoginActivity.class); //
                    startActivityForResult(loginIntent, AUTH_REQUEST_CODE);
                } else if (wear_msg.contains("open")) {
    ...
    public void onResume() {
        super.onResume();
        //String fromIntent = this.getIntent().getStringExtra("wear_command");
    }

//    @Override
//    protected void onNewIntent(Intent intent) {
//        super.onNewIntent(intent);
//        Log.v(TAG, "    newIntent was passed in " + intent.getStringExtra("wear_command"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case org.forgerock.auth.R.id.login:
                ...
                content.setText("");
                Intent loginIntent = new Intent(this, SimpleLoginActivity.class); //rj?
                startActivityForResult(loginIntent, AUTH_REQUEST_CODE);
                return true;
